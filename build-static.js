    ...
    <nav class="sticky top-0 z-50 border-b border-slate-200/80 bg-slate-50/70 backdrop-blur-md transition-colors duration-300 dark:border-zinc-800/80 dark:bg-zinc-950/70">
      <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-4">
          ...
          <!-- App Actions -->
          <a href="https://app.autocompt.ca/?login=1" class="bg-amber-500 hover:bg-amber-600 active:scale-[0.98] transition-all text-white font-semibold text-xs px-5 py-2.5 rounded-lg shadow-lg shadow-amber-500/25 flex items-center gap-1.5">
            <i data-lucide="log-in" class="w-3.5 h-3.5"></i>
            <span data-t="nav.login">${t.nav.login}</span>
          </a>
        ...
        <div class="flex md:hidden items-center gap-2">
          ...
          <!-- Visible directly on mobile, not just inside the hamburger
               drawer — a returning user shouldn't have to open the menu
               to find "Se connecter". Requested 2026-08-25 (Fabiola,
               testing on her phone). -->
          <a href="https://app.autocompt.ca/?login=1" class="w-9 h-9 flex items-center justify-center rounded-xl bg-amber-500 hover:bg-amber-600 text-white shadow-md shadow-amber-500/25" title="${t.nav.login}">
      ...
      <div id="mobile-drawer" class="hidden md:hidden px-6 pb-6 border-b border-slate-200 bg-slate-50 flex flex-col gap-4 animate-fadeIn transition-colors duration-300 dark:bg-zinc-950 dark:border-zinc-850">
        ...
        <div class="flex flex-col gap-3 mt-4">
          <a href="https://app.autocompt.ca/?login=1" class="w-full text-center bg-amber-500 hover:bg-amber-600 text-white font-bold text-sm py-3 rounded-xl shadow-lg shadow-amber-500/25 flex items-center justify-center gap-1.5">
            <i data-lucide="log-in" class="w-4 h-4"></i>
            <span data-t="nav.login">${t.nav.login}</span>
          </a>
